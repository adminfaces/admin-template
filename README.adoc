...
++++
<img align="right" height="400" width="500" src="https://github.com/adminfaces/admin-template/blob/master/template-example.png" style="max-width:100%;">
++++
...
image::admin-template-regions.png[link="https://github.com/adminfaces/admin-template/blob/master/src/main/resources/META-INF/resources/admin.xhtml"]