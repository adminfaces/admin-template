...
++++
<img align="right" height="350" width="350" src="https://github.com/adminfaces/admin-template/blob/master/template-example.png" style="max-width:100%;">
++++
...
<img align="right" height="400" width="300" src="https://github.com/adminfaces/admin-template/blob/master/admin-template-regions.png" style="max-width:100%;">
</a>
++++