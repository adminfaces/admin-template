...
++++
<img style="float:right" height="350" width="400" src="https://github.com/adminfaces/admin-template/blob/master/template-example.png" style="max-width:100%;">
++++
...
There are also other regions defined in admin.xhtml template:

++++
<a href="https://github.com/adminfaces/admin-template/blob/master/admin-template-regions.png">
<img align="center" height="600" width="800" src="https://github.com/adminfaces/admin-template/blob/master/admin-template-regions.png" style="max-width:100%;">
</a>
++++