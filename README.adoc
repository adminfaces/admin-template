...
++++
<img align="right" height="350" width="400" src="https://github.com/adminfaces/admin-template/blob/master/template-example.png" style="max-width:100%;">
++++
...
The above page definition renders as fo
